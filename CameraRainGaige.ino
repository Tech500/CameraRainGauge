///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
// 
//                       Version  3.6 CameraRainGauge.ino 1/23/2022 # 18:35 EST  Developed by William  M. Lucid
//                      
//
...
void setup(void)
{
  ...
  Serial.println("");
  Serial.println("\n\nVersion  3.6 CameraRainGauge.ino 1/23/2022 # 18:35 EST");
...
static void smartDelay(unsigned long ms)
{
  ...
  do
  {
    ...
    while (Serial2.available())
      gps.encode(Serial2.read()); // Send it to the encode function
