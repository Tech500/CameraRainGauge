///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
// 
//                       Version  3.3  'RainGauge.ino' 10/12/2021 @ 17:20 EDT  Developed by William  M. Lucid
...
void setup(void)
{
  ...
  Serial.println("");
  Serial.println("\n\nVersion  3.3  'RainGauge.ino' 10/12/2021 @ 17:20 EDT");
  ...
  */
  ...
  /*
       serverAsync.on("/ACCESS.TXT", HTTP_GET, [](AsyncWebServerRequest * request)
       {
            ...
            if(! flag == 1)
            {
                 request->send(SPIFFS, "/ACCESS.TXT");
...
void webInterface()
{
  ...
  //Requires collectData2.php file be placed on hosted domain web site; in my case folder was public_html.	
