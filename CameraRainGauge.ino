///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
// 
//                       Version  3.6.2 CameraRainGauge.ino 06/28/2022 @ 01:05 EDT  Developed by William  M. Lucid
//               
//                       C:\Users\1234\Documents\Smart_DOW_Brownout_CameraRainGauge
//
//                       Sketch folder:  C:\Users\1234\Documents\Smart_DOW_Brownout_CameraRainGauge
//
//                       Uploaded to Github 1/23/2022 Current Verdion 3.6
//
//                       Licensed under GNU GPL v3.0, https://www.gnu.org/licenses/gpl.html
//
//                       C:\Users\1234\Documents\Smart_DOW_Brownout_CameraRainGauge\CameraRainGauge.ino   Dated: 06/28/2022
//
//
...
void setup(void)
{
  ...
  Serial.println("");
  Serial.println("\n\nVersion  3.6.2 CameraRainGauge.ino 6/28/2022 @ 01:05 EDT");
  Serial.println("Please wait; for network connection...");
  Serial.println("");

  if (rtc_get_reset_reason(0) == 1)  //VBAT_RESET) 
  {
    ...
    Serial.println("Vbat reset previous boot");
      
  }
  
  if (rtc_get_reset_reason(0) == 12)  //SOFTWARE_RESET) 
  {
...
void loop() 
{
  ...
  if ((brownout == 1) || (softReset == 1))  
  {
    ...
    else
    {
      ...
      logFile.print("ESP32 Restart caused by Watchdog Event...\n");
