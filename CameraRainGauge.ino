///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
// 
//                       Version  3.4  'Brownout_CameraRainGauge.ino' 11/17/2021 @ 00:30 EST  Developed by William  M. Lucid
...
#import "index7.h"  //display video RTSP Stream
...
void setup(void)
{
  ...
  Serial.println("");
  Serial.println("\n\nVersion  3.4  Brownout_CameraRainGauge.ino' 11/17/2021 @ 00:30 EST");
...
void loop() 
{
  ...
  if(brownout == 1)
  {
    ...
    logFile.print("ESP32 Brownout:    ");  

    logFile.print(dtStamp);

    logFile.print("   ESP32 Restart");
  ...
  /*
  //Executes 15 Minute routine and one Five Minute Rountine.  Used for testing ISRBrownout
